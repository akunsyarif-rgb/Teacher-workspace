...
import { ArrowLeft, BarChart3, Calendar, BookOpen, Users } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs font-bold text-gray-500">Memuat statistik...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          {weeklyStats.days.length > 0 ? (
            <>
              ...
              <p className="text-[10px] text-gray-400 text-center">
                Jumlah jurnal dan presensi per hari
              </p>
            </>
          ) : (
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4">
          <p className="text-xs font-medium text-amber-700">
            💡 Grafik ini menunjukkan aktivitas Anda dalam 7 hari terakhir. 
            Semakin tinggi batang, semakin banyak aktivitas yang Anda lakukan.
          </p>
        </div>
      </div>
    </div>
